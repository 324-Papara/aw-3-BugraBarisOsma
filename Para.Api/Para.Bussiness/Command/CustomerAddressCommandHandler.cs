    ...
    IRequestHandler<DeleteCustomerAddressCommand, ApiResponse>
{
    ...
    private readonly ILogger<CustomerAddressCommandHandler> logger;

    public CustomerAddressCommandHandler(IUnitOfWork unitOfWork, IMapper mapper, ILogger<CustomerAddressCommandHandler> logger)
    {
