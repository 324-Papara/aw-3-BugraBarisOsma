...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      //  var connectionsStringSql2 = Configuration.GetConnectionString("PostgresSqlConnection");
      //  services.AddDbContext<ParaDbContext>(options => options.UseNpgsql(connectionsStringSql2));
